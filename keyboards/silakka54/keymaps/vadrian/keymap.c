...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MEDIA] = LAYOUT(
        ...
        _______, _______, _______, _______, QK_LLCK, _______, _______, _______, _______, _______, _______, _______,
    ...
    [NAV] = LAYOUT(
        ...
        _______, _______, _______, _______, QK_LLCK, _______, C_REDO,  C_PASTE, C_COPY,  C_CUT,    C_UNDO,  _______,
    ...
    [SYM] = LAYOUT(
        ...
        _______, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE, _______, QK_LLCK, _______, _______, _______, _______,
    ...
    [NUM] = LAYOUT(
        ...
        _______, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, _______, QK_LLCK, _______, _______, _______, _______,
    ...
    [FUN] = LAYOUT(
        ...
        _______, KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUSE, _______, QK_LLCK, _______, _______, _______, _______,
